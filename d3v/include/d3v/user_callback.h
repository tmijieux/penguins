...
typedef void (*mouse_callback_t)(int button, int state, int mods, int x,int y);
typedef void (*key_input_callback_t)(int key, int scancode, int action, int mods, int x,int y);
