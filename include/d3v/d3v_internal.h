...
__so_local extern struct scene scene;
__so_local extern Display *display;
__so_local extern Window win;
__so_local extern GLXContext ctx;
__so_local extern Colormap cmap;
